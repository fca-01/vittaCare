...
export default function ServicesSection() {
  ...
  return (
    <div className="h-fit md:h-[90vh] p-5 mb-10 md:mx-20  font-sans flex flex-col justify-center items-centergap-6 text-center">
      <div className="flex flex-col md:flex-row md:justify-between items-center mb-10 md:mb-0">
        <div className="flex flex-col gap-5 w-full text-start">
          <Title size="lg">Nossos <FancyTitle size="lg">serviços</FancyTitle></Title>
          <Description className="text-center md:text-start">Whether youre a beginner or an advanced practitioner, our offerings are designed to inspire and support you on your wellness journey.</Description>
        </div>
        <Button >Veja mais serviços</Button>
      </div>
      <div className="grid md:grid-cols-3 md:text-start gap-20 w-full mt-5 md:mt-16">
        {services.map((service, index) => (
          <div key={index} className="flex flex-col gap-2 w-full justify-center items-center">
            ...
            <h1 className="font-normal text-xl md:text-2xl text-[#102e16]">{service.service}</h1>
